                ...
                <li v-for="response in question.responses">
                  <label>
                    ...
                    <input type="radio" 
                          ...
                          v-model="selectedrole"> {{response.text}}
                  </label>
                </li>
              </ol>
...
export default {
    ...
    mounted() {
      ...
      const { box, box2, cane } = this.$refs
      const timeline = new TimelineLite();
      var overlapThreshold = "50%"; 
      var k = 0
      console.log("the cane", cane);
      ...
      Draggable.create(box2, {
        bounds:window,
        onDrag: function(e) {
            if (this.hitTest(cane, overlapThreshold)) {
              console.log("HO COLPITO IL CANE", k);
              k += 1;
            }
          },
